			...
			<table class="table table-bordered table-hover"
				...
				<tbody>
					...
					<tr>
						...
						<td><input class="form-control" type="text" maxlength= "50" name="boardTitle" placeholder="Title" value="<%= board.getBoardTitle() %>"></td>
					</tr>
					<tr>
						<td style="width: 100px;"><h5>Content</h5></td>
						<td><textarea  class="form-control" rows="10" name="boardContent" maxlength="2048" placeholder="Content"><%= board.getBoardContent() %></textarea></td>
					</tr>
					<tr>
