	...
	<div class="container">
		<form method="post" action="./userProfile" enctype="multipart/form-data">
			<table class="table table-bordered table-hover"
				...
				<thead>
					<tr>
						<th colspan="2"><h4>Edit Profile Picture</h4></th>
					</tr>
				</thead>
				<tbody>
					<tr>
					...
					<tr>
						<td style="width: 100px;"><h5>Upload</h5></td>
						<td colspan="2"><input type="file" name="userProfile" class="file">
						<div class="input-group col-xs-8" style="margin: auto;">
							<span class="input-group-addon"><i class="glyphicon glyphicon-picture"></i></span>
							<input type="text" class="form-control input-lg" disabled placeholder="Upload an image">
